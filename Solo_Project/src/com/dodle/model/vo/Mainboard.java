...
public class Mainboard {
	...
	public Mainboard(int mbNo, String mbName, String mbMfrName, int mbPrice, Date mbRelease) {
		super();
		this.mbNo = mbNo;
		this.mbName = mbName;
	...
	public String toString() {
		return "Mainboard 고유번호"+mbNo + ", 메인보드 이름 : " + mbName + ", 메인보드 제조회사 이름 : " + mbMfrName + ", 메인보드 출시일 : "
				 + ", 메인보드 가격 : " + mbPrice + "\n\n";
	}
